    ...
    <div className="fixed inset-0 z-40 bg-[#070b14] overflow-y-auto min-h-screen flex flex-col relative" dir="rtl">
      ...
      <div className="flex-1 flex flex-col items-center justify-center pt-12 lg:pt-24 pb-12 px-4 relative z-10 w-full max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center gap-5 text-center max-w-3xl">
          ...
          {/* מובייל/טאבלט: במרכז מתחת לכיתוב | מחשב: בפינה העליונה */}
          <button
            type="button"
            onClick={() => setShowModal(true)}
            className="bg-transparent border-2 border-[#3bc1ca] text-[#3bc1ca] hover:bg-[#3bc1ca] hover:text-[#070b14] px-6 py-2.5 rounded-full font-bold transition-all shadow-[0_0_15px_rgba(59,193,202,0.3)] flex items-center gap-2 text-sm md:text-base max-lg:mt-2 lg:fixed lg:top-6 lg:right-10 lg:z-50"
          >
