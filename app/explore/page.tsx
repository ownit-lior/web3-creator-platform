      ...
      <section className="relative overflow-hidden border-b border-[#1e2a44]/40">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 md:py-20">
          ...
          <h1 className="mt-6 max-w-3xl font-display text-4xl font-bold tracking-tight text-white md:text-5xl lg:text-6xl">
            Invest in Culture. Join the Club.
          </h1>
          <p className="mt-4 max-w-2xl text-lg leading-relaxed text-slate-300 md:text-xl">
            Back musicians, artists, game devs, and storytellers — earn real returns or unlock
            exclusive community perks across every creative vertical.
          </p>
        </div>
      </section>
        ...
        {activeTab === 'investments' && (
          <div className="space-y-12">
            <div className="flex items-center gap-2 text-sm text-slate-400">
              ...
              Financial focus — token price, APY, and funding progress
            </div>
            {CATEGORY_CONFIG.map((cat) => {
              ...
              return (
                <CategoryCarousel
                  ...
                  subtitle={`${assets.length} opportunities`}
                >
                  {assets.map((asset) => (
        ...
        {activeTab === 'clubs' && (
          <div className="space-y-12">
            <div className="flex items-center gap-2 text-sm text-slate-400">
              ...
              Community focus — members, utilities, and tier status by token holdings
            </div>
            {CATEGORY_CONFIG.map((cat) => {
        ...
        {activeTab === 'drops' && (
          <div className="space-y-8">
            <div className="flex items-center gap-2 text-sm text-slate-400">
              ...
              Projects launching soon — set a reminder before the drop goes live
            </div>
